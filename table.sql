...
CREATE TABLE `category`(
  ...
  `category_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '分类名称',
...
CREATE TABLE `comment`(
  ...
  `username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '评论人',
  `create_time` timestamp(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '评论时间',
  `status` int(244) UNSIGNED NOT NULL COMMENT '评论状态：0, 删除；1，正常',
